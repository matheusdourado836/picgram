      ...
      body: Container(
        ...
        child: ListView(
          children: <Widget>[
            ...
            SizedBox(height: 24,),
            ElevatedButton(
                onPressed: () => store.loginWith(
                    email: _emailController.text,
                    password: _passwordController.text).catchError((error) {
                  showDialog(
                      context: context,
                      builder: (ctx) {
                        return AlertDialog(
                          ...
                          actions: [
                            ElevatedButton(onPressed: () {Navigator.of(ctx).pop(); store.loading = false;}, child: Text('OK'))
                          ],
                        );
                      }
                  );
